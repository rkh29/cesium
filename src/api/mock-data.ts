...
const groundStations = [
  {
    id: "ground-boundary-west",
    name: "边界监测站-西",
    latitude: 75.2,
    longitude: 39.1,
  },
  {
    id: "ground-boundary-east",
    name: "边界监测站-东",
    latitude: 134.8,
    longitude: 35.4,
  },
  {
    id: "ground-boundary-south",
    name: "边界监测站-南",
    latitude: 110.3,
    longitude: 18.3,
  },
  {
    id: "ground-boundary-north",
    name: "边界监测站-北",
    latitude: 123.5,
    longitude: 53.2,
  },
...
export const mockInstanceResources: Record<string, InstanceResource> =
  Object.fromEntries(
